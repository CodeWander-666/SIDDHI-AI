...
<head>
    ...
    <style>
        ...
        [data-theme="rich"] { /* ... */ }
        [data-theme="sunny"] { /* ... */ }
        body { background-color: rgb(var(--bg-rgb)); color: rgb(var(--text-rgb)); }
        /* ... include all your CSS classes ... */
    </style>
    <script>
        tailwind.config = {
            theme: {
...
if __name__ == "__main__":
    main()        logging.FileHandler(os.path.join(BLOG_DIR, 'blog_generator.log'), mode='a')
    ]
)
logger = logging.getLogger(__name__)
